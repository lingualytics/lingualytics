    ...
    <div className="pt-4 bg-dark">
      <Container fluid>
                ...
                return (
                  <li key={i} className="mr-1">
                    <a
                      ...
                      className="text-primary h5 font-weight-light pr-1"
                    >
                      <Icon path={data.icon} color="white" size={1} />
                    </a>
                  </li>
                );
              })}
        ...
        <Row className="pb-3 text-white mt-3">
          <Col sm="12" lg={{ offset: 1, size: "auto" }}>
            <p className="ml-lg-5 mb-0 small font-weight-light">
              Copyright © 2020 All rights reserved | Made by{" "}
              <a href="https://www.blotlabs.com/">blot labs</a>
            </p>
          </Col>
        </Row>
      </Container>
